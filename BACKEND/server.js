...
app.use('/api/reports', require('./routes/reportsEnhanced')); // Enhanced reports with ML & Bank Ratings
app.use('/api/bank-ratings', require('./routes/bankRatings')); // Bank credit ratings API
app.use('/api/investments', require('./routes/investments')); // Investment capital planner API
